...
import { IconArrowBackUp, IconCheck, IconEdit, IconEye, IconTrash } from '@tabler/icons-react';
            ...
            content: ({record, collapse}) =>(
                <Box p="md">
                    <Grid>
                        ...
                        <TextInput label="Name" size="xs" value={record.name} onChange={(value) => console.log(value)}/>
                        </Grid.Col>
                        {/* other fields... */}
                        <Grid.Col span={12}>
