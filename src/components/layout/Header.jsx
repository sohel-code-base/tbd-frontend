...
import {useNavigate} from 'react-router-dom'
  ...
  export default function Header({navbarOpened, toggleNavbar, rightSidebarOpened, toggleRightSideBar}) {
      ...
      <Box h={`100%`}>
        <Group justify="space-between" h="100%">
            ...
            <Group>
                ...
                >
                  <Menu.Target>
                    <UnstyledButton p={2} className={LanguagePickerStyle.control} data-expanded={languageOpened || undefined}>
                      <Group gap="xs">
                        <Image src={languageSelected?.flag} width={22} height={22} />
              ...
              <Tooltip label={fullscreen ? t('normal_screen') : t('fullscreen')} bg={`green`}>
              ...
              <Tooltip label={rightSidebarOpened ? t('collapse_right_sidebar') : t('expand_right_sidebar')} bg={`indigo`}>
                  <ActionIcon onClick={toggleRightSideBar} variant='light' color='indigo' size={20} radius={`xs`} p={0}>
                      {rightSidebarOpened ? <IconChevronRight /> : <IconChevronLeft/>}
                  </ActionIcon>
              </Tooltip>
            </Group>
